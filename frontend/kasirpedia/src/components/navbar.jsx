...
export default function Navbar(props) {
  ...
  return (
    <Flex as="nav" justify="space-between" align="center" p="2px 20px" bg={'#0e66b3'} minW={'100vw'} boxShadow="0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);" pos={'sticky'} zIndex={8} top="0">
      <Link href="#">
      ...
      <Menu>
        ...
        >
          <Text>{user?.name}</Text>
          <Text fontSize="xs">{isAdmin ? 'Admin' : 'Cashier'}</Text>
        </MenuButton>
